<template>
  <article>
    ...
    <main>
      ...
      <a href="https://goo.gl/maps/uWxqGC5QD5khrb476" rel="noreferrer nofollow" target="_blank">
        Ava mäpsis
      </a>

      <details>
        <summary>Näita kaarti</summary>
      ...
      <h2 id="menuu">Menüü</h2>

      <p>
        Rikkalik buffet peaks kõikide toitumisvajadused rahuldama, kuid kui keegi tunneb, et tema
        maitsemeeltele sobilik menüüst puudub, siis anda sellest meile vaikselt märku.
      </p>
      ...
      <p>
        Õnnelik on see inimene, kes saab autoga mitte ainult kohale, vaid ka minema. Tubli! Sinu
        eeskujulikkus on kadestusväärne ning peaksid enda auto võimalusel kaassõitjatega täitma.
      </p>
      <p>
